...
const Createpage = () => {
    ...
    return (<>
        <div className='fixed z-30 inset-0 flex justify-center items-center'>
            <div className='absolute inset-0 size-full bg-slate-700 opacity-75' />
            <div className='relative z-40 shadow-2xl w-md bg-stone-100 border-stone-200 border-2 rounded-xl p-6'>
                <div className='mb-6'>
